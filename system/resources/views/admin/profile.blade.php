            ...
            <div class="card-body">
                ...
                <div class="text-center mb-4">
                    <img id="currentProfile"
                        src="{{ url('public/app/data-admin/' . Auth::user()->foto_profil) }}"
                        alt="Foto Profil"
                ...
                <form id="updateForm" action="{{ url('admin/profil/' . $admin->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="phone" id="phone" name="phone"
                            class="form-control" value="{{ Auth::user()->phone }}" required>
                    </div>

                    <div>
                        <label for="asal_sekolah" class="form-label">Asal Sekolah</label>
                        <input type="text" id="asal_sekolah" name="asal_sekolah"
                            class="form-control" value="{{ Auth::user()->sekolahs ? Auth::user()->sekolahs->nama_sekolah : '' }}" readonly>
                    </div>
